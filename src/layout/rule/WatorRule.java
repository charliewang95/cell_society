...
public class WatorRule extends Rule {
	...
	public WatorRule(double cellLength, int sizeX, int sizeY, int neighbor, int side, Color water, Color fish, Color shark,
		...
		myLegend[0] = myResources.getString("WatorLegendFish");
		myLegend[1] = myResources.getString("WatorLegendShark");
	}
